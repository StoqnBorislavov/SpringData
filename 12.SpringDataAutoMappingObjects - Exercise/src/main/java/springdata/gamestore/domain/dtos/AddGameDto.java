...
public class AddGameDto {
    ...
    //@Pattern(regexp = "([http]+:\\/\\/)+", message = "ImageThumbnail is not valid")
    ...
    public AddGameDto(String title, BigDecimal price, double size, String trailer, String imageThumbnail, String description, LocalDate releaseData) {
        this.title = title;
        this.price = price;
        this.size = size;
